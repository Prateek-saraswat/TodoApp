      ...
      <div className="admin-dashboard">
        <div className="dashboard-container">
                      ...
                      <td>
                        <div className="action-buttons">
                          <button
                            ...
                            onClick={() =>
                              toggleUserStatus(user.id?.toLowerCase())
                            }
                            title={
                              user.status === "Active"
                                ? "Deactivate"
                          ...
                          <button
                            ...
                            style={{
                              ...
                              opacity: user.role ==='admin' ? 0.45 : 1,
                            }}
                            title={
                              user.role === 'admin'
          ...
          {showAddUserModal && (
            ...
            //   </div>
            // </div>
            <AddUserModal  showAddUserModal={showAddUserModal} setShowAddUserModal={setShowAddUserModal} handleAddUser={handleAddUser} newUser={newUser}handleInputChange={handleInputChange} errors={errors} />
          )}
        </div>
      </div>
    </>
